...
public abstract class Control : INotifyPropertyChanged, IDisposable {
    ...
    public static readonly DesignStandard ControlStandard = new(/*          Size */ Point.Zero,
    ...
    public static class StandardColors {
        ...
        /// </summary>
        public static Color Default => new(0xffffffff);
        ...
        /// </summary>
        public static Color DisabledText => new(0xffaaaaaa);
        ...
        /// </summary>
        public static Color Shadow => new(0xff000000);
    ...
    protected Point _size = new(40, 20);
    /// <summary>
    ...
    /// </summary>
    [JsonIgnore]
    public Rectangle LocalBounds => new(this.Location, this.Size);
    ...
    public string BasicTooltipText {
        ...
        set {
            ...
            if (ActiveControl == this && _tooltip != null) {
