...
public static class Mouse
{
    ...
    private static Dictionary<MouseButton, MouseEventF> ButtonPress = new()
    {
    ...
    private static Dictionary<MouseButton, MouseEventF> ButtonRelease = new()
    {
    ...
    private static Dictionary<MouseButton, VirtualKeyShort> VirtualButtonShort = new()
    {
    ...
    private static Dictionary<MouseButton, uint> WM_BUTTONDOWN = new()
    {
    ...
    private static Dictionary<MouseButton, uint> WM_BUTTONUP = new()
    {
    ...
    private static Dictionary<MouseButton, uint> WM_BUTTONDBLCLK = new()
    {
