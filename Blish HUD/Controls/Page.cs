...
public class Page : Control
{
    ...
    private static BitmapFont PageNumberFont = GameService.Content.GetFont(FontFace.Menomonia, FontSize.Size18, FontStyle.Regular);
    ...
    private BitmapFont _textFont = GameService.Content.GetFont(FontFace.Menomonia, FontSize.Size24, FontStyle.Regular);
    /// <summary>
