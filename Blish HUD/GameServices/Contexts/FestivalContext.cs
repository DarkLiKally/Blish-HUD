...
public class FestivalContext : Context {
    ...
    public readonly struct Festival {
        ...
        private static readonly Dictionary<string, Festival> _festivalLookup = new(StringComparer.InvariantCultureIgnoreCase);
        ...
        /// </summary>
        public static readonly Festival UnknownFestival = new("unknown", Strings.Common.Unknown);
        ...
        /// </summary>
        public static readonly Festival Halloween = new("halloween", Strings.GameServices.Contexts.Festivals.Festival_Halloween);

        /// <summary>
        /// Guild Wars 2 Wintersday Festival.
        /// </summary>
        public static readonly Festival Wintersday = new("wintersday", Strings.GameServices.Contexts.Festivals.Festival_Wintersday);

        /// <summary>
        /// Guild Wars 2 Super Adventure Festival.
        /// </summary>
        public static readonly Festival SuperAdventureFestival = new("superadventurefestival", Strings.GameServices.Contexts.Festivals.Festival_SuperAdventureFestival);

        /// <summary>
        /// Guild Wars 2 Lunar New Year Festival.
        /// </summary>
        public static readonly Festival LunarNewYear = new("lunarnewyear", Strings.GameServices.Contexts.Festivals.Festival_LunarNewYear);

        /// <summary>
        /// Guild Wars 2 Festival of the Four Winds.
        /// </summary>
        public static readonly Festival FestivalOfTheFourWinds = new("festivalofthefourwinds", Strings.GameServices.Contexts.Festivals.Festival_FestivalOfTheFourWinds);

        /// <summary>
        /// Guild Wars 2 Dragon Bash Festival.
        /// </summary>
        public static readonly Festival DragonBash = new("dragonbash", Strings.GameServices.Contexts.Festivals.Festival_DragonBash);

    }

    private const string DAILY_GROUP_ID = "18DB115A-8637-4290-A636-821362A3C4A8";

    private readonly Dictionary<int, Festival> _knownFestivalCategories = new() {
    ...
    private List<Festival> _activeFestivals = new();
