...
public class ArcDpsService : GameService {
    ...
    private readonly ConcurrentDictionary<uint, ConcurrentBag<Action<object, RawCombatEventArgs>>> _subscriptions = new();
    ...
    protected override void Initialize() {
        ...
        #if DEBUG
        this.RawCombatEvent += (_, _) => { Interlocked.Increment(ref Counter); };
        #endif
    }
