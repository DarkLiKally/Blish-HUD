...
public class ModuleDependencyView : TitledDetailView {
    ...
    private readonly Dictionary<ModuleDependencyCheckResult, Color> _dependencyDisplayColor = new() {
    ...
    protected override void BuildDetailView(Panel buildPanel) {
        ...
        _ignoreModuleDependenciesToggle.CheckedChanged += delegate(object _, CheckChangedEvent e) { IgnoreModuleDependencies = e.Checked; };
