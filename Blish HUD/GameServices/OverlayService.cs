...
public class OverlayService : GameService {
    ...
    public GameTime CurrentGameTime { get; private set; } = new(TimeSpan.Zero, TimeSpan.Zero);
    ...
    public bool InterfaceHidden;

    private readonly ConcurrentQueue<Action<GameTime>> _queuedUpdates = new();
    ...
    private void PrepareSettingsTab() {
        ...
        // About
        this.SettingsTab.RegisterSettingMenu(new MenuItem(Strings.GameServices.OverlayService.AboutSection, Content.GetTexture("440023")),
                                             (_) => new AboutView(),
                                             int.MinValue);

        // Overlay Settings
        this.SettingsTab.RegisterSettingMenu(new MenuItem(Strings.GameServices.OverlayService.OverlaySettingsSection, Content.GetTexture("156736")),
                                             (_) => new OverlaySettingsView(),
                                             int.MaxValue - 12);
    }
