...
public class KeyboardHandler : IInputHandler {
    ...
    private readonly ConcurrentQueue<KeyboardEventArgs> _inputBuffer = new();

    private readonly List<Keys> _keysDown = new();
    ...
    private readonly HashSet<Keys> _hookIgnoredKeys = new() {
        Keys.NumLock,
        Keys.CapsLock,
        Keys.LeftWindows,
        Keys.RightWindows,
    ...
    private readonly ReaderWriterLockSlim _stagedKeyBindingLock = new();
    private readonly HashSet<KeyBinding>  _stagedKeyBindings    = new();
