...
public readonly struct ShadersSetting {
    ...
    public static implicit operator ShadersSetting(string value)          => new(value);

    public static ShadersSetting Low    { get; } = new(SETTING_LOW);
    public static ShadersSetting Medium { get; } = new(SETTING_MEDIUM);
    public static ShadersSetting High   { get; } = new(SETTING_HIGH);
