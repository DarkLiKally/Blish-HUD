...
public readonly struct PostProcSetting {
    ...
    public static implicit operator PostProcSetting(string value)           => new(value);

    public static PostProcSetting Low    { get; } = new(SETTING_LOW);
    public static PostProcSetting Medium { get; } = new(SETTING_MEDIUM);
    public static PostProcSetting High   { get; } = new(SETTING_HIGH);
