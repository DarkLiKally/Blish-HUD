...
public readonly struct FrameLimitSetting {
    ...
    public static implicit operator FrameLimitSetting(string value)             => new(value);

    public static FrameLimitSetting Unlimited { get; } = new(SETTING_UNLIMITED);
    public static FrameLimitSetting Value60   { get; } = new(SETTING_60);
    public static FrameLimitSetting Value30   { get; } = new(SETTING_30);
