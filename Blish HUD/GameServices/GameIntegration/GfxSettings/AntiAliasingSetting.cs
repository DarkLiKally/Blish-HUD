...
public readonly struct AntiAliasingSetting {
    ...
    public static implicit operator AntiAliasingSetting(string value)               => new(value);

    public static AntiAliasingSetting None     { get; } = new(SETTING_NONE);
    public static AntiAliasingSetting FXAA     { get; } = new(SETTING_FXAA);
    public static AntiAliasingSetting SMAALow  { get; } = new(SETTING_SMAALOW);
    public static AntiAliasingSetting SMAAHigh { get; } = new(SETTING_SMAAHIGH);
