...
public readonly struct CharModelLimitSetting {
    ...
    public static implicit operator CharModelLimitSetting(string value)                 => new(value);

    public static CharModelLimitSetting Lowest  { get; } = new(SETTING_LOWEST);
    public static CharModelLimitSetting Low     { get; } = new(SETTING_LOW);
    public static CharModelLimitSetting Medium  { get; } = new(SETTING_MEDIUM);
    public static CharModelLimitSetting High    { get; } = new(SETTING_HIGH);
    public static CharModelLimitSetting Highest { get; } = new(SETTING_HIGHEST);
