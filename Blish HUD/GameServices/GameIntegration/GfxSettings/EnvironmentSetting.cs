...
public readonly struct EnvironmentSetting {
    ...
    public static implicit operator EnvironmentSetting(string value)              => new(value);

    public static EnvironmentSetting Low    { get; } = new(SETTING_LOW);
    public static EnvironmentSetting Medium { get; } = new(SETTING_MEDIUM);
    public static EnvironmentSetting High   { get; } = new(SETTING_HIGH);
