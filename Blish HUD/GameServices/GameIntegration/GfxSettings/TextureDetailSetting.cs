...
public readonly struct TextureDetailSetting {
    ...
    public static implicit operator TextureDetailSetting(string value)                => new(value);

    public static TextureDetailSetting Low    { get; } = new(SETTING_LOW);
    public static TextureDetailSetting Medium { get; } = new(SETTING_MEDIUM);
    public static TextureDetailSetting High   { get; } = new(SETTING_HIGH);
