...
public readonly struct SamplingSetting {
    ...
    public static implicit operator SamplingSetting(string value)           => new(value);

    public static SamplingSetting Subsample   { get; } = new(SETTING_SUBSAMPLE);
    public static SamplingSetting Native      { get; } = new(SETTING_NATIVE);
    public static SamplingSetting Supersample { get; } = new(SETTING_SUPERSAMPLE);
