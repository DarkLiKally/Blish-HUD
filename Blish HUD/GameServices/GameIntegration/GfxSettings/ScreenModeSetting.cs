...
public readonly struct ScreenModeSetting {
    ...
    public static implicit operator ScreenModeSetting(string value)             => new(value);

    public static ScreenModeSetting Windowed           { get; } = new(SETTING_WINDOWED);
    public static ScreenModeSetting Fullscreen         { get; } = new(SETTING_FULLSCREEN);
    public static ScreenModeSetting WindowedFullscreen { get; } = new(SETTING_WINDOWEDFULLSCREEN);
