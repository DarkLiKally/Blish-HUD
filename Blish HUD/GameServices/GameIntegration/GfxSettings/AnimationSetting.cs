...
public readonly struct AnimationSetting {
    ...
    public static implicit operator AnimationSetting(string value)            => new(value);

    public static AnimationSetting Low    { get; } = new(SETTING_LOW);
    public static AnimationSetting Medium { get; } = new(SETTING_MEDIUM);
    public static AnimationSetting High   { get; } = new(SETTING_HIGH);
