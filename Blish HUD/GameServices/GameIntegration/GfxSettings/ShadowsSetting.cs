...
public readonly struct ShadowsSetting {
    ...
    public static implicit operator ShadowsSetting(string value)          => new(value);

    public static ShadowsSetting Off    { get; } = new(SETTING_OFF);
    public static ShadowsSetting Low    { get; } = new(SETTING_LOW);
    public static ShadowsSetting Medium { get; } = new(SETTING_MEDIUM);
    public static ShadowsSetting High   { get; } = new(SETTING_HIGH);
    public static ShadowsSetting Ultra  { get; } = new(SETTING_ULTRA);
