...
public readonly struct CharModelQualitySetting {
    ...
    public static implicit operator CharModelQualitySetting(string value)                   => new(value);

    public static CharModelQualitySetting Lowest  { get; } = new(SETTING_LOWEST);
    public static CharModelQualitySetting Low     { get; } = new(SETTING_LOW);
    public static CharModelQualitySetting Medium  { get; } = new(SETTING_MEDIUM);
    public static CharModelQualitySetting High    { get; } = new(SETTING_HIGH);
    public static CharModelQualitySetting Highest { get; } = new(SETTING_HIGHEST);
