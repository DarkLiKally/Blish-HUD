...
public sealed class AudioIntegration : ServiceModule<GameIntegrationService> {
    ...
    private readonly RingBuffer<float>     _audioPeakBuffer             = new(AUDIOBUFFER_LENGTH);
    ...
    private readonly List<(MMDevice AudioDevice, AudioMeterInformation MeterInformation)> _gw2AudioDevices = new();
