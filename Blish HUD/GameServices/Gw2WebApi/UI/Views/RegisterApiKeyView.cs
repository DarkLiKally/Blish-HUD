...
public class RegisterApiKeyView : View {
    ...
    private static readonly ProcessStartInfo ArenaNetApplicationsWebsiteProcessStartInfo = new() {
    ...
    private readonly Dictionary<ApiTokenStatusType, Texture2D> _tokenStatusTextures = new() {
