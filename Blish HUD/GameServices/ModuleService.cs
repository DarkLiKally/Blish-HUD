...
public class ModuleService : GameService {
    ...
    private List<ModuleDependency> _incompatibleModules = new(0);
    ...
    private readonly List<ModuleManager>          _modules = new();
    ...
    protected override void Load() {
        ...
        if (GameIntegration.Gw2Instance.Gw2IsRunning) {
            Gw2Instance_Gw2Started(null, null);
        } else {
            GameIntegration.Gw2Instance.Gw2Started += Gw2Instance_Gw2Started;
        }
    }
    ...
    private readonly Dictionary<MenuItem, ModuleManager> _moduleMenus = new();
    ...
    protected override void Update(GameTime gameTime) {
        foreach (var module in _modules) {
            ...
            if (module.Enabled && (GameIntegration.Gw2Instance.Gw2IsRunning || module.Manifest.EnabledWithoutGW2)) {
                Debug.StartTimeFunc(module.Manifest.Name);
                try {
                ...
                Debug.StopTimeFunc(module.Manifest.Name);
            }
        }
    }
